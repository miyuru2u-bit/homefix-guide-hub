---
title: "Should You Repair or Replace an Oven?"
slug: "should-you-repair-or-replace-an-oven"
metaDescription: "Repair or replace your oven or range? Use the 50% rule, age guidelines, common repair costs, and a clear decision framework to make the right call."
category: "repair-vs-replace"
tags: ["oven", "range", "stove", "repair or replace", "igniter", "heating element", "50% rule"]
date: "2026-06-11"
author: "Editorial Team"
image: "repair-or-replace-oven"
imageAlt: "Kitchen oven with the door open and tools nearby, illustrating repair vs replace"
quickAnswer: "Repair your oven if it's under 12 years old and the fix costs less than half the price of a comparable new one. Most oven problems — bake/broil elements, igniters, sensors, thermostats — are affordable, common repairs ($100–$300) worth doing. Lean toward replacement if it's 15+ years old, needs a control board repair nearing $400, or is a pricey built-in with multiple failures."
costTable: []
faq:
  - q: "Is it worth repairing an oven that won't heat?"
    a: "Yes, in most cases. No-heat is usually a bake/broil element (electric) or igniter (gas) — both inexpensive, common repairs worth doing well into the oven's life."
  - q: "What is the most expensive oven repair?"
    a: "The electronic control board (ERC) or touchpad, at $200–$400. On an older range, it can justify replacement."
  - q: "How long does an oven or range last?"
    a: "Typically 13–15 years — the longest-lived of the major kitchen appliances, especially gas ranges with simpler controls."
  - q: "Why is my oven not heating to the right temperature?"
    a: "Commonly a failed temperature sensor (RTD) or thermostat, or a weakening bake element. A sensor test (about 1,080 ohms at room temperature on many models) helps pinpoint it."
  - q: "Does a home warranty cover oven repairs?"
    a: "Yes, ovens and ranges are commonly covered. A covered breakdown means you pay just the service fee up to the plan cap."
---
...
2. **Is the fix an element, igniter, sensor, thermostat, or burner?** Repair — cheap and common at almost any age.
3. **Is it 15+ years old facing a $350+ control-board repair, or are there multiple failures?** Consider replacement.
4. **In the 12–15 year range?** Apply the 50% rule.
5. **Is it a built-in or premium model?** Bias strongly toward repair — replacement is costly and disruptive.
