---
title: 'Appliance Repair vs Replacement: When to Fix or Replace'
slug: appliance-repair-vs-replacement
metaDescription: Should you repair or replace a broken appliance? Learn how to compare repair cost, appliance age, reliability, warranty coverage, and replacement value.
...
image: appliance-repair-vs-replacement
imageAlt: Homeowner comparing appliance repair estimate with new appliance replacement options
quickAnswer: When a major appliance breaks, the first question is usually not “what part failed?” It is “should I repair it or replace it?”
faq:
- q: Is it better to repair or replace an appliance?
  a: Repair is usually better when the appliance is newer, the repair is affordable, and the appliance has been reliable. Replacement may be better when the repair cost is high, the appliance is old, parts are unavailable, or breakdowns are frequent.
- q: What is the 50% rule for appliance repair?
  a: The 50% rule suggests replacing an appliance if the repair cost is more than half the cost of a comparable new appliance, especially if the appliance is already near the end of its expected life.
- q: How old should an appliance be before replacing it?
  a: It depends on the appliance type, condition, and repair history. Refrigerators, washers, dryers, dishwashers, ovens, and ranges all have different typical lifespans, so age should be considered with repair cost and reliability.
- q: Should I repair an appliance under warranty?
  a: If the repair is covered by warranty and the appliance is otherwise worth keeping, repair usually makes sense. Check service fees, claim limits, and replacement terms before deciding.
- q: When is appliance repair not worth it?
  a: Appliance repair may not be worth it when the repair is close to replacement cost, the appliance is old, parts are discontinued, efficiency is poor, or repeated repairs are likely.
---
...
Related guide: [Appliance Warranty vs Repair Cost: When to Pay Out of Pocket](/blog/appliance-warranty-vs-repair-cost)
...
Related guide: [Appliance Warranty Claims: What to Expect Before You File](/blog/appliance-warranty-claims-what-to-expect)

## A simple repair vs replacement checklist

Use this checklist:

1. What is the repair estimate?
2. What is the cost of a comparable replacement?
3. How old is the appliance?
4. Has it been reliable?
5. Are parts available?
6. Is the repair covered by warranty?
7. What is the service fee?
8. Would replacement require installation extras?
9. Is the appliance efficient?
10. Are future repairs likely?
11. How urgent is the repair?
12. Would you be happy keeping the appliance?

## Average appliance lifespans

Age is the other half of the equation. An expensive repair on a near-new appliance may still be worth it; the same repair on a unit near the end of its life rarely is.
...
Once an appliance passes about 75% of its expected lifespan, the odds of additional failures climb and replacement starts to look better even for moderate repairs.

## How to find your appliance's age

If you do not know how old an appliance is, check the serial number on the data plate (often inside the door, on the back, or near the base). Most manufacturers encode the manufacture date in the serial number, and free serial-number decoders can translate it. Knowing the true age sharpens every part of this decision.
